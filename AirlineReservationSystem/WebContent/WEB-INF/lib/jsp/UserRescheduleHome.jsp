...
<body>
	...
	<form method="post" action="showRescheduleBookingDetails.usr" name = "frm" onsubmit="return validateHome(this)">
		<table id ="table">
			<thead>
			<tr>
					<th><h4>Reschedule Booking</h4></th>
			</tr>
			</thead>
			<tbody>
				<tr>
				<td>Please Enter your booking id: </td>
				<td><input type="text" id="bookingid" name="bookingId"  pattern="[0-9]{5,5}" title="Must be in 5 digits only !!" required autofocus/>
				</tr>
			</tbody>
			<tfoot>
				<tr>
