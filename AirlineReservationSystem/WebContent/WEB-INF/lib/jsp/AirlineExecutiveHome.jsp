...
<aside class="sidebar">
    <table>
        <tr >
            <td></td>
            <td><div class ="options"><a href ="showFlightOccupancyPeriod.exc">View Flight Occupancy for given period</a></div></td>
        </tr>
		<tr></tr>
        <tr>
            <td></td>
            <td><div class = "options"><a href = "showFlightOccupancyCity.exc">View Flight Occupancy for given cities</a></div></td>
        </tr>
	</table>
</aside>
