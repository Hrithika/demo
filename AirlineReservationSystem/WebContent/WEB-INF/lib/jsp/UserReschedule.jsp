...
<body>
	...
	<form method="post" action="rescheduleBookingDetails.usr" name = "frm" onsubmit="return validateHome(this)">
		<table id ="table">
			<thead>
			<tr>
			...
			<tbody>
				...
				<td><input type="radio" id="yes" name="reschedule" value="Y" checked/>Yes
				<input type="radio" id="no" name="reschedule" value="N" />No</td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
