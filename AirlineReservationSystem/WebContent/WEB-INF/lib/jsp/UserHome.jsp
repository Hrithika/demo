...
<aside class="sidebar">
    <table>
        <tr >
            <td></td>
            <td><div class ="options"><a href ="showBookFlight.usr">Book Flight</a></div></td>
        </tr>
		<tr></tr>
        <tr>
            <td></td>
            <td><div class = "options"><a href ="showUserManageHome.usr">Manage My  Booking</a></div></td>
        </tr>
        <tr >
            <td></td>
            <td><div class = "options"><a href ="showViewFlightStatus.usr">View Flight Status</a></div></td>
        </tr>
	</table>
</aside>
