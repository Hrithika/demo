...
<div id="wrapper">
	...
	<div id="page">
		...
		<form:form action="viewFlightStatus.usr" modelAttribute="viewFlight" method="post" >
				<h2 align="center">View Flight Status</h2>
				<table align="center">
					<tr>
						<th>Booking Id </th>
							<td><form:input path="bookingId" required="true" pattern="[0-9]{5}" title="Must be in 5 digits only !!"/></td>
					</tr>
