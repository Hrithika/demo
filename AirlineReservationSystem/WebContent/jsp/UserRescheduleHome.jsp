...
<div id="wrapper">
	...
	<form:form method="post" action="showRescheduleBookingDetails.usr" modelAttribute="bookBean" name = "frm" onsubmit="return validateHome(this)">
		<table id ="table">
			<tbody>
				<tr>
				<td>Please Enter your booking id: </td>
				<td><form:input path="bookingId" autofocus="true" required="true" pattern="[0-9]{5}" title="Must be in 5 digits only !!"/></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
