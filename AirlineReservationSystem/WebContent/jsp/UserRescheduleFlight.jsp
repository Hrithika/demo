...
<div id="wrapper">
	...
	<form:form method="post" action="rescheduleBookingChooseFlightDetails.usr?flight=${previousFlight}" modelAttribute="rescheduleBookInfoBean" name = "frm" onsubmit="return validateHome(this)">
		<table id ="table">
			<thead>
			<tr>
			...
			<tbody>
				...
				<c:set var="flight" value="${list.getFlightNo()}"></c:set>
				<th><form:radiobutton path="flightNo" value="${flight}"/>${list.getFlightNo()}:${list.getAirline()}</th>
