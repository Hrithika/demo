...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="contentbg">
				<div class="post">
					<h2 class="title">Delete Flight</h2>
					<div class="entry">
		<section class="contentarea">
		<form:form action="deleteFlight.adm" modelAttribute="deleteFlight" method="post" onsubmit="return validateDeleteFlightHome(this)">
				<table align="center">
					<tr>
						<th>Flight Number </th>
							<td><form:input path="flightNo" required="true" title="Must be in 4 digits only" pattern="[0-9]{4}"/></td>
							<td id ="flighterr" class ="error"></td>
							<td>${msgObj}</td>
					</tr>
