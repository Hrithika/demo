...
<div id="wrapper">
	...
	<div id="page">
		...
		<form:form action="updateFlightHome.adm" modelAttribute="updateFlight" method="post" >
				<h2 align="center">Update Flight Details</h2>
				<table align="center">
					<tr>
						<th>Flight Number </th>
							<td><form:input path="flightNo" required="true" pattern="[0-9]{4}" title="Must be in 4 digits only !!"/></td>
							<td><form:errors path="flightNo"/></td>
					</tr>
					
					<tr>
						<th><button type="submit">Update Flight</button></th>
						<th><button type="submit">Reset</button></th>
					</tr>
