...
<div id="wrapper">
	...
	<form:form method="post" action="validateLogin.do" name = "frm" modelAttribute="userObj" onsubmit="return validateHome(this)">
		<table id ="table">
			
			<tbody>
				<tr>
				<td>User Name </td>
				<td><form:input path="userName" autofocus="true" required="true"/></td>
