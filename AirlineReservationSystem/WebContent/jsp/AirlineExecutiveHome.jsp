...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="contentbg">
				<div class="post">
					<h2 class="title">Welcome Executive</h2>
					<div class="entry">
			<section class="contentarea">
			<table>
        <tr >
            <td></td>
            <td><div class ="links"><a href ="showFlightOccupancyPeriod.exc">View Flight Occupancy for given period</a></div></td>
        </tr>
		<tr></tr>
        <tr>
            <td></td>
            <td><div class = "links"><a href = "showFlightOccupancyCity.exc">View Flight Occupancy for given cities</a></div></td>
        </tr>
	</table>
			</section>
					</div>
