...
<div id="wrapper">
	...
	<form:form method="post" action="flightPeriodDisplay.exc" modelAttribute="flight" name = "frm" onsubmit="return validateHome(this)">
		<table id ="table">
			<tbody>
				
				<tr>
					<td><h4>Enter the Time Period to Retrieve Flight Occupancy</h4></td>
				</tr>
				
				<tr>
				<td>Enter the airline</td>
				<td>
					<form:input path= "airline" required="true" title="Must be in characters in range of 5 to 30 !!" pattern="[A-Za-z ]{5,30}" />
				...
				<td>
					<form:input type="date" id="myDate" path= "tempDeptDate" min="${minDate}" max="${maxDate}" required="true"/>
					<form:errors path= "tempDeptDate" />
				</td>
				</tr>
				<tr>
				<td>Enter the Ending Date:</td>
				<td>
					<form:input type="date" id="myDate" path= "tempArrDate" min="${minDate}" max="${maxDate}" required="true"/>
					<form:errors path= "tempArrDate" />
				</td>
				</tr>
				<tr>
				<td>Enter the Starting Time:</td>
				<td>
					<form:input path= "deptTime" required="true" pattern="[0-9]{4}" title="Must be in this format: HHMM"/>
					<form:errors path= "deptTime" />
				</td>
				</tr>
				<tr>
				<td>Enter the Ending Time:</td>
				<td>
					<form:input path= "arrTime" required="true" pattern="[0-9]{4}" title="Must be in this format: HHMM"/>
